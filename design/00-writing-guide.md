...
`docs/`（利用者向け）は文章品質規範のみ適用し、詳細は[ユーザードキュメント規範](../docs/00-user-docs-guide.md)を優先する。
...
| `docs/**/*.md` | 部分的 | 利用者向けは[ユーザードキュメント規範](../docs/00-user-docs-guide.md)を優先 |
...
利用者向けドキュメント（`docs/`）のコード・コマンドの扱いは[ユーザードキュメント規範](../docs/00-user-docs-guide.md)を参照。
